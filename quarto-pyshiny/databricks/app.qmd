---
title: "Databricks Dashboard (find by name)"
format: dashboard
server: shiny
---
...
OAuth via `find_by(name=DATABRICKS_INTEGRATION_NAME)`
...
def load_all():
    ...
    db_assoc = current_content.oauth.associations.find_by(name=integration_name)
    if db_assoc is None:
        ui.notification_show(
            f"No Databricks integration found with name: {integration_name}", type="error"
        )
        return
