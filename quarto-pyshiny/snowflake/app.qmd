---
title: "Snowflake Dashboard (find by name)"
format: dashboard
server: shiny
---
...
OAuth via `find_by(name=SNOWFLAKE_INTEGRATION_NAME)`
...
def load_all():
    ...
    sf_assoc = current_content.oauth.associations.find_by(name=integration_name)
    if sf_assoc is None:
        ui.notification_show(
            f"No Snowflake integration found with name: {integration_name}", type="error"
        )
        return
